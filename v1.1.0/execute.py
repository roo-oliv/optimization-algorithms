...
###########################################################################################	
###########################################################################################	
def TabuSearch(Itermax, sbjHPW, sbjGroup, sbjBook, profBook, sbjSche, profSche, profSubject, profPeriod):
	...
	while(Iter-BestIter<Itermax):
		Iter += 1
		BestMove,BestIter = get.Best(BestIter, [], T, Ti, sbjHPW, sbjGroup, sbjBook, profBook, sbjSche, profSche, profSubject, profPeriod)
	...
	return sbjBook, profBook, sbjSche, profSche, BestMove_log
