...
###########################################################################################	
###########################################################################################	
def Variables(sbjGroups,profSubject,sbjProfs,candAval,profPeriod,sbjPeriod,sbjHPW,sbjOrdered,sbjBook,sbjBook0,profBook,profBook0,profSche,profSche0,BestMove_log):
	f = open('variables', 'w')
