...
###########################################################################################
###########################################################################################
def Best(BestIter, rejected, T, Ti, sbjHPW, sbjGroups, sbjBook, profBook, profSche, profSubject, profPeriod):
	...
	if(bypass > 0):
		...
		BestMove, BestIter = Best(BestIter, rejected, T, Ti, sbjHPW, sbjGroups, sbjBook, profBook, profSche, profSubject, profPeriod)
