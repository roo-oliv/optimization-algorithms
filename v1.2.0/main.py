...
def main(p=50,Itermax=1000):
	...
	sbjBook, profBook, profSche, BestMove_log = execute.TabuSearch(Itermax, sbjHPW, sbjGroups, sbjBook, profBook, profSche, profSubject, profPeriod) # Runs tabu search algorithm
	
	t3 = time.perf_counter() # Records time after tabu search execution
	
	write.Variables(sbjGroups,profSubject,sbjProfs,candAval,profPeriod,sbjPeriod,sbjHPW,sbjOrdered,sbjBook,sbjBook0,profBook,profBook0,profSche,profSche0,BestMove_log) # Writes important variables in a file
