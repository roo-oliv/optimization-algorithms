...
for professor in (range(len(solution.profBook)-mod)):
	...
	c.create_rectangle(x, y+30, x+124, y+48, fill="#fff", tags=("0n","init")) # Blank rectangle

	c.create_rectangle(x, y+48, x+124, y+120, fill="#fff", tags=("1n","init"))     # 
	...
	c.create_rectangle(x, y+120, x+124, y+192, fill="#fff", tags=("2n","init"))    # 
	...
	c.create_rectangle(x, y+192, x+124, y+228, fill="#fff", tags=("3n","init"))    # 
	...
	c.create_rectangle(x, y+228, x+124, y+300, fill="#fff", tags=("4n","init"))    # 
	...
	c.create_rectangle(x, y+300, x+124, y+372, fill="#fff", tags=("5n","init"))    # 
	...
	c.create_rectangle(x, y+372, x+124, y+408, fill="#fff", tags=("6n","init"))    # 
	...
	c.create_rectangle(x, y+408, x+124, y+480, fill="#fff", tags=("7n","init"))    # 
	...
	c.create_rectangle(x, y+480, x+124, y+552, fill="#fff", tags=("8n","init"))    # 
	...
	for i in range(5):
		...
		c.create_rectangle(x+124+i*186, y+48, x+310+i*186, y+120, fill="#fff", tags=("0,"+str(2*i),"init"))
		c.create_rectangle(x+124+i*186, y+120, x+310+i*186, y+192, fill="#fff", tags=("0,"+str(2*i+1),"init"))
		c.create_rectangle(x+124+i*186, y+192, x+310+i*186, y+228, fill="#fff")
		c.create_rectangle(x+124+i*186, y+228, x+310+i*186, y+300, fill="#fff", tags=("1,"+str(2*i),"init"))
		c.create_rectangle(x+124+i*186, y+300, x+310+i*186, y+372, fill="#fff", tags=("1,"+str(2*i+1),"init"))
		c.create_rectangle(x+124+i*186, y+372, x+310+i*186, y+408, fill="#fff")
		c.create_rectangle(x+124+i*186, y+408, x+310+i*186, y+480, fill="#fff", tags=("2,"+str(2*i),"init"))
		c.create_rectangle(x+124+i*186, y+480, x+310+i*186, y+552, fill="#fff", tags=("2,"+str(2*i+1),"init"))
